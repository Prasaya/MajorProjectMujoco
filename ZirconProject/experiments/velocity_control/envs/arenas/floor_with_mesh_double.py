...
class FloorWithMesh(Arena):
    ...
    def _build(self, size=(100, 100), reflectance=.2, aesthetic='default',
        ...
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_10-2",
                                      mesh='chair',
                                      pos=[44, -17, 0],
                                      size=[1, 1, 1])
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_11-2",
                                      mesh='chairL',
                                      pos=[44, -21, 0],
                                      size=[1, 1, 1])
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_12-2",
                                      mesh='chair',
                                      pos=[43, -20, 0],
                                      size=[1, 1, 1])
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_13-2",
                                      mesh='chairF',
                                      pos=[44.5, -19.75, 0],
                                      size=[1, 1, 1])
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_14-2",
                                      mesh='chairF',
                                      pos=[45, -16, 0],
                                      size=[1, 1, 1])
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_15-2",
                                      mesh='chairR',
                                      pos=[47, -16, 0],
                                      size=[1, 1, 1])
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_16-2",
                                      mesh='chairR',
                                      pos=[48, -17, 0],
                                      size=[1, 1, 1])
        self.mjcf_model.worldbody.add('geom',
                                      type='mesh',
                                      name="chair_rand_17-2",
                                      mesh='chairR',
                                      pos=[49, -18, 0],
                                      size=[1, 1, 1])
